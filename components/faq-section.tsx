...
const faqs = [
  ...
  },
  {
    ...
    answer: "Our Professional plan includes priority 24/7 support, real-time analytics, custom integrations, and a dedicated account manager to keep your AI systems improving over time.",
  },
  {
